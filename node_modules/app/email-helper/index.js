var nodemailer = require('nodemailer'),
    ...
    toAddress = 'comagictest1@yandex.ru';
...
module.exports = {
    ...
    sendReviewEmail: function(review, product, callback) {
        subject = 'Добавлен отзыв на продукт ' + product.name;
        text = review.customerName + ' пишет: \n' +
            review.text + '\n' +
            'Ссылка на продукт: ' + 'gsoap.ru/#/products/' + product._id;
    ...
    sendOrderEmail: function(order, callback) {
        ...
        text += '\nКонтактные данные:\n\n' +
                ...
                (order.discountNumber ? 'Номер купона на скидку: ' + order.customerInfo.discountNumber + '\n' : '') +
                'Способ доставки: ' + order.customerInfo.deliveryType + '\n' +
